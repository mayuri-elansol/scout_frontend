...
const meta: Meta<typeof ScoutInput> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'SCOUT Input component for form fields with consistent styling. Includes search variant with integrated search icon.',
      },
    },
  },
  tags: ['autodocs'],
...
export const Search: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Search input with integrated search icon for filtering and searching.',
      },
    },
  },
};
...
export const DifferentTypes: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', maxWidth: '300px' }}>
      ...
      <ScoutInput label="Password Input" placeholder="Enter password" type="password" />
      <ScoutInput label="Number Input" placeholder="Enter number" type="number" />
