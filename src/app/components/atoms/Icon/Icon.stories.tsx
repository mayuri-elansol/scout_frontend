...
const meta: Meta<typeof ScoutIcon> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'SCOUT Icon component using Material-UI icons with consistent sizing and coloring. Used throughout the application (50+ instances).',
      },
    },
  },
  tags: ['autodocs'],
  argTypes: {
    name: {
      control: 'select',
      options: [
        'Shield', 'Warning', 'Visibility', 'People', 'DirectionsCar',
        'Schedule', 'Place', 'Download', 'Clear', 'Search', 'Add',
        'Home', 'BarChart', 'Settings', 'VideoCall', 'Description',
        'TrendingUp', 'Security', 'LocalFireDepartment', 'Circle',
        'ExpandMore', 'ExpandLess', 'ChevronRight', 'Menu'
      ],
    ...
    color: {
      control: 'select',
      options: ['primary', 'secondary', 'success', 'error', 'warning', 'info', 'disabled', 'action', 'inherit'],
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(100px, 1fr))', gap: '16px' }}>
      {[
        ...
        <div key={name} style={{ textAlign: 'center' }}>
          <ScoutIcon name={name as any} size="large" color="primary" />
