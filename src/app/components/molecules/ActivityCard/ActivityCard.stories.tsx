...
**Note**: Cards are fixed at 320px width to match the actual SCOUT application layout.
  ...
  argTypes: {
    cardType: {
      control: 'select',
      options: ['employee', 'ppe_violation', 'security_breach', 'personnel_tracking'],
    ...
    alertStatus: {
      control: 'select',
      options: ['active', 'acknowledged', 'resolved', 'investigating', 'escalated'],
...
export const EmployeeActive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Employee activity card showing active status with live feed preview.',
      },
    },
  },
};
...
export const EmployeeMissing: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Employee marked as missing with red status indicator and last seen timestamp.',
      },
    },
  },
};
...
export const EmployeeLoadingFeed: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Employee card with loading feed animation and enhanced visual feedback.',
      },
    },
  },
};
...
export const PPEViolationMedium: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'PPE violation for missing safety vest with medium priority, already acknowledged.',
      },
    },
  },
};
...
export const SecurityBreachCritical: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Critical security breach alert for unauthorized access at main gate.',
      },
    },
  },
};
...
export const SecurityBreachEscalated: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Critical security breach that has been escalated to higher authorities.',
      },
    },
  },
};
...
export const EmployeeGrid: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Employee tracking grid layout as it appears in the actual SCOUT application.',
      },
    },
  },
};
...
export const SecurityBreachGrid: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Security breach alerts grid as shown in Intrusion Detection page.',
      },
    },
  },
};
