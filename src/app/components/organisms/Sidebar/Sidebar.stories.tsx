...
const meta: Meta<typeof Sidebar> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'SCOUT Navigation Sidebar with collapsible analytics categories, dashboard navigation, and Elansol Technologies branding. Provides access to all analytics pages and system features.',
      },
    },
  },
  tags: ['autodocs'],
...
export const Alerts: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Sidebar with System Alerts page selected, showing notification badge.',
      },
    },
  },
};
