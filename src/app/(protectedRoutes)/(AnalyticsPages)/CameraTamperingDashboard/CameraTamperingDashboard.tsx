...
// // 1️⃣ Tampering by Time of Day
// const hourlyTampering = [
//   { hour: "00:00", count: 2 },
//   { hour: "04:00", count: 3 },
//   { hour: "08:00", count: 5 },
//   { hour: "12:00", count: 6 },
...
// // 2️⃣ Top 5 Cameras by Tampering Frequency
// const topCameras = [
...
//           { dataKey: "lensCovered", label: "Lens Covered", color: "#A8E6CF" },
//         ]}
...
// // 4️⃣ Tampering by Time of Day
// const TimeOfDaySection = () => (
//   <DynamicBarChart
//     data={hourlyTampering}
//     xAxisKey="hour"
//     series={[{ dataKey: "count", label: "Tampering", color: "#F9AB00" }]}
...
//     data={topCameras}
//     xAxisKey="camera"
//     series={[{ dataKey: "incidents", label: "Incidents", color: "#ffcdd2" }]}
//     yAxisLabel="Count"
//   />
// );

// // 7️⃣ Camera Health Summary
// const CameraHealthSection = () => (
//   <DynamicBarChart
//     data={cameraHealth}
//     xAxisKey="zone"
//     series={[
...
//     { label: "Tampering Trend", content: <TamperingTrendSection /> },

//     { label: "Camera Uptime", content: <CameraUptimeSection /> },
//     { label: "Top Cameras", content: <TopCamerasSection /> },
//     { label: "Camera Health Summary", content: <CameraHealthSection /> },
//   ];
