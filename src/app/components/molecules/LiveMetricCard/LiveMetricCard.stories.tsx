...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Live metric card component used to display key performance indicators on the Live Streaming page. Features colored borders and large value display.",
      },
    },
  },
  decorators: [
  ...
  decorators: [
    () => (
      <Grid container spacing={3} sx={{ maxWidth: "800px", p: 2 }}>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <LiveMetricCard value="3" label="Active Violations" color="#f44336" />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <LiveMetricCard value="234" label="People Detected" color="#4caf50" />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <LiveMetricCard
            value="12"
