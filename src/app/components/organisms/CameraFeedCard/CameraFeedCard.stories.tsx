...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Complete camera feed card component used in Live Streaming page. Combines video feed, AI overlays, controls, and zone metrics in a single card.',
      },
    },
  },
  decorators: [
...
export const LiveStreamingGrid: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Camera feed cards as they appear in the Live Streaming page grid layout.',
      },
    },
  },
};