...
import ZoneMetricsPanel, { ZoneMetric } from '../../molecules/ZoneMetricsPanel/ZoneMetricsPanel';
      ...
      <Box sx={{ position: 'relative', p: 2, pb: 1 }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            ...
            <Typography variant="caption" sx={{ color: getStatusColor(zone.status), fontWeight: 600 }}>
              {zone.status}
            </Typography>
          </Box>
        </Box>
