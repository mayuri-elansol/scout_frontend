...
export const PPEViolationsReport: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "PPE violations report as it appears in the PPE Detection analytics page.",
      },
    },
  },
};
...
export const SecurityIncidentsReport: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Security incidents report as it appears in the Intrusion Detection analytics page.",
      },
    },
  },
};
...
export const EmployeePresenceReport: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Employee presence report as it appears in the Employee Presence analytics page.",
      },
    },
  },
};
...
export const PeopleCountReport: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "People count report as it appears in the People Count analytics page.",
      },
    },
  },
};
