...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Comprehensive showcase of all SCOUT components working together as they appear in the actual application.",
      },
    },
  },
  tags: ["autodocs"],
...
export const ComponentOverview: Story = {
  render: () => (
    <Box sx={{ backgroundColor: "#f8f9fa", minHeight: "100vh" }}>
      ...
      <Box sx={{ p: 3, mt: 8 }}>
        <Typography
          variant="h4"
          sx={{ mb: 4, color: "#1c2025", fontWeight: 600 }}
        >
        ...
        {/* Atoms Section */}
        <Box sx={{ mb: 4 }}>
          <Typography variant="h5" sx={{ mb: 3, color: "#1c2025" }}>
            Atoms
          </Typography>
        ...
        >
          ...
          >
            This showcase demonstrates how SCOUT components work together in the
            actual application:
          </Typography>
          <Box component="ul" sx={{ mt: 2, pl: 2, color: "#5c6b7d" }}>
            <li>
              <strong>Atoms</strong>: Basic UI elements (buttons, badges) used
              throughout
            </li>
            <li>
              <strong>Molecules</strong>: Composed components (KPI cards,
              activity cards) for specific features
            </li>
            <li>
              <strong>Organisms</strong>: Complex components (header, sidebar,
              activity feed) for page structure
            </li>
            <li>
              <strong>Templates</strong>: Full page layouts combining all
              component levels
            </li>
          </Box>
        </Box>
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Complete overview showing how all SCOUT components work together in the application.",
      },
    },
  },
};
...
export const DashboardPreview: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Preview of how components appear together in the actual SCOUT dashboard layout.",
      },
    },
  },
};
