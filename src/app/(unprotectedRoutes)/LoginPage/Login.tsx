  ...
  return (
    <Card
      ...
      sx={{
        ...
        background:
          "linear-gradient(135deg, rgba(25, 118, 210, 0.02) 0%, rgba(66, 165, 245, 0.05) 100%)",
        transform: hovered
        ...
        "&:hover": {
          background:
            "linear-gradient(135deg, rgba(25, 118, 210, 0.05) 0%, rgba(66, 165, 245, 0.08) 100%)",
    ...
    <ThemeProvider theme={theme}>
      ...
      <Box
        sx={{
          minHeight: "100vh",
          background:
            "linear-gradient(135deg, #1e3c72 0%, #2a5298 50%, #1976d2 100%)",
          position: "relative",
          "&::before": {
            content: '""',
            position: "absolute",
      ...
      >
        ...
        >
          <Grid
            container
            spacing={4}
            sx={{ minHeight: "calc(100vh - 150px)", alignItems: "center" }}
          >
