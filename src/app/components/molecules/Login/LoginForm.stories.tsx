...
const meta: Meta<typeof LoginForm> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A login form component with username, password fields and forgot password functionality. The remember me option has been removed.',
      },
    },
  },
  decorators: [
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Default login form with username and password fields. Try demo/password for successful login.',
      },
    },
  },
};
...
export const WithError: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Login form displaying an error message after failed login attempt.',
      },
    },
  },
};
