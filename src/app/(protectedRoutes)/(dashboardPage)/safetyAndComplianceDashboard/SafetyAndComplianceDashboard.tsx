...
//   const zoneColors = ["#ffcdd2", "#FFCBB3", "#FFEAA7", "#C7EDCC", "#A8E6CF"];
//   const allZones = new Set([
//     ...Object.keys(fireSmokeZoneWise?.fire ?? {}), // ["Elansol"] ✅
//     ...Object.keys(fireSmokeZoneWise?.smoke ?? {}), // ["Elansol"] ✅
//   ]);
//   const zoneWisePieData = Array.from(allZones).map((zone, i) => ({
//     label: zone,
//     value:
...
//               <DynamicPieChart
//                 data={zoneWisePieData}
//                 count={zoneWisePieData.reduce((sum, d) => sum + d.value, 0)}
//                 carttitle="Zone-wise Hazard Detection"
//               />
//             </Box>
//           </Grid>
