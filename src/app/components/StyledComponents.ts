...
// KPI Card Components
export const KpiCardContainer = styled(Card)<{ bgcolor: string }>(({ theme, bgcolor }) => ({
...
export const KpiTrendChip = styled(Box)<{ trendcolor: string }>(({ theme, trendcolor }) => ({
  fontSize: '12px',
  fontWeight: 600,
  color: trendcolor,
...
export const CameraStatusCount = styled(Typography)<{ statuscolor: string }>(({ theme, statuscolor }) => ({
  fontSize: '14px',
  fontWeight: 600,
  color: statuscolor,
}));
