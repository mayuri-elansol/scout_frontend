...
export const Default: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Default SCOUT header as it appears in the application with full branding and status indicators.',
      },
    },
  },
};
...
export const WithSidebarLayout: Story = {
  render: () => (
    <Box sx={{ position: 'relative', height: '400px', backgroundColor: '#f5f7fa' }}>
      <Header />
  ...
  parameters: {
    docs: {
      description: {
        story: 'Header in the complete SCOUT layout showing how it works with sidebar and main content positioning.',
      },
    },
  },
};
