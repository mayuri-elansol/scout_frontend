...
const meta: Meta<typeof ActivityStatusPanel> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'SCOUT Activity Status Panel template combining personnel cards and critical zone status. This is the complete layout shown in the screenshots with personnel grid on the left and zone status sidebar on the right.',
      },
    },
  },
  tags: ['autodocs'],
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Default activity status panel layout exactly matching the screenshot.',
      },
    },
  },
};
