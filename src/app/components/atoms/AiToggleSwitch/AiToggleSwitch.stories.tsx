...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'AI Processing toggle switch component used in Live Streaming page. Includes status chip and customizable styling for SCOUT analytics platform.',
      },
    },
  },
  argTypes: {
...
export const LiveStreamingContext: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'AI toggle switch as it appears in the Live Streaming page header.',
      },
    },
  },
};