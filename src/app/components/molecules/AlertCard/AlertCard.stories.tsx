...
import { Warning, ErrorOutline, Person, InfoOutlined } from '@mui/icons-material';
...
export const AcknowledgedAlert: Story = {
  args: {
    ...
    description: 'Required Level 3 operator not present in chemical processing unit',
    severity: 'HIGH',
    status: 'ACKNOWLEDGED',
    category: 'Workforce',
...
export const AlertsList: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Multiple alert cards as they appear in the SCOUT Alerts page list.',
      },
    },
  },
};
