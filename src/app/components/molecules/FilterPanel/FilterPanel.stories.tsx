...
const meta: Meta<typeof FilterPanel> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "SCOUT Filter Panel component for data filtering across analytics pages. Supports multiple filter types including select dropdowns, search inputs, and date ranges (7 instances).",
      },
    },
  },
  tags: ["autodocs"],
