...
const StyledCard = styled(Card)<{
  ...
  alertstatus?: string;
  priority?: string;
}>(({ cardtype, status, alertstatus, priority }) => {
...
const LiveFeedPreview = styled(Box)<{
  feedstatus?: string;
  clickable?: boolean;
}>(({ feedstatus, clickable }) => {
  ...
  return {
    ...
    "&:hover": clickable
      ? {
          backgroundColor:
            feedstatus === "live" ? "#d6ecf0" : getBackgroundColor(),
        ...
        <Box sx={{ display: "flex", gap: 1, mt: 2 }}>
          <Button
            ...
            sx={{
              flex: 1,
              backgroundColor:
                cardType === "security_breach" ? "#f44336" : "#2196f3",
              color: "white",
              fontWeight: 500,
              fontSize: "14px",
              textTransform: "none",
              "&:hover": {
                backgroundColor:
                  cardType === "security_breach" ? "#d32f2f" : "#1976d2",
              },
            }}
          >
