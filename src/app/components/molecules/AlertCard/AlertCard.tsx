      ...
      <CardContent sx={{ p: 3 }}>
        <Box sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', mb: 2 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, flex: 1 }}>
            <IconComponent sx={{ color: severityColors.borderColor, fontSize: 20 }} />
            <Box sx={{ flex: 1 }}>
              ...
              <Typography sx={{ color: '#666', fontSize: '14px', mb: 1.5, lineHeight: 1.4 }}>
                {description}
              </Typography>
            </Box>
          </Box>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, ml: 2 }}>
            <Typography sx={{ color: '#999', fontSize: '12px', fontFamily: 'monospace' }}>
              {id}
            </Typography>
            <Button
              variant="contained"
        ...
        {/* Quick Actions */}
        <Box>
          <Typography sx={{ fontSize: '12px', color: '#666', mb: 1, fontWeight: 500 }}>
            Quick Actions:
          </Typography>
