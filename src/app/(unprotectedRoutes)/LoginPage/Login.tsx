    ...
    try {
      ...
      if (foundUser) {
        ...
        localStorage.setItem(
          "scout_user",
          JSON.stringify({ username: foundUser.username, lastLogin: new Date().toISOString() })
        );
      ...
      <Box sx={{ minHeight: "100vh", backgroundColor: "#f8f9fa" }}>
        ...
        >
          <Container maxWidth="sm">
            ...
            >
              <Box sx={{ padding: 4, paddingTop: 5, textAlign: "center", backgroundColor: "#ffffff", borderBottom: "1px solid #f0f0f0" }}>
                <Box
                  sx={{
                    width: 56,
                    height: 56,
                ...
                <Typography variant="h4" sx={{ fontWeight: 700, mb: 1, color: "#000000", fontSize: "28px" }}>
                  Sign in to SCOUT
                </Typography>
                <Typography variant="body1" sx={{ color: "#5c6b7d", fontSize: "16px" }}>
              ...
              <Paper sx={{ textAlign: "center", py: 3, backgroundColor: "#fafafa", borderTop: "1px solid #f0f0f0", borderRadius: "0 0 8px 8px" }} elevation={0}>
