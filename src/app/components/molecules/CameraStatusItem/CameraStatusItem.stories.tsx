...
const meta: Meta<typeof CameraStatusItem> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'SCOUT Camera Status Item component for individual camera monitoring with status, quality metrics, and controls. Used in camera management interfaces.',
      },
    },
  },
  tags: ['autodocs'],
