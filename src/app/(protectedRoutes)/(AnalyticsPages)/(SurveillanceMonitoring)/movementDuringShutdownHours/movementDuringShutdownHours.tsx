...
//   /* ---------- STATE ---------- */
//   const [isShutdownLiveMode, setIsShutdownLiveMode] = useState(true);

//   const [displayShutdownKpi, setDisplayShutdownKpi] = useState<
//     MovemnetDuringShutDownHrKpiItem[]
//   >([]);
//   const [displayShutdownZoneViolations, setDisplayShutdownZoneViolations] =
//     useState<MovemnetDuringShutDownHrZoneViolation[]>([]);
//   const [recentShutdownViolationsLive, setRecentShutdownViolationsLive] =
//     useState<MovemnetDuringShutDownHrViolation[]>([]);
//   const [detailedShutdownReport, setDetailedShutdownReport] =
...
//   /*-------movemnet during shutdown hrs api ----------*/

//   const [fetchShutdownKpi, { isLoading: shutdownkpiLoading }] =
//     useLazyGetIntrusionKpiQuery();

//   const [fetchShutdownRecent, { isLoading: shutdownrecentLoading }] =
//     useLazyGetIntrusionRecentViolationsQuery();
//   const [fetchShutdownZoneViolations, { isLoading: shutdownzoneLoading }] =
//     useLazyGetIntrusionZoneViolationsQuery();

//   const [fetchDetailedShutdownReportApi, { isLoading: shutdownreportLoading }] =
//     useLazyGetIntrusionDetailedReportQuery();
//   const [downloadShutdownSinglePdf] =
//     useGetIntrusionDetectionSingleReportPdfMutation();

//   const [downloadShutdownCsvReport] =
//     useGetIntrusionDetectionDetailedCsvReportMutation();
//   const [downloadShutdownPdfReport] =
