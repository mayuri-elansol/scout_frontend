...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Camera feeds grid component that displays multiple CameraFeedCard components in a responsive grid layout. Used in the main content area of the Live Streaming page.',
      },
    },
  },
  argTypes: {
