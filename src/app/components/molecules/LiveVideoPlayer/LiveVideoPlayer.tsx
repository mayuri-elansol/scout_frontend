...
//=====================================new code chnaged userelatime hook according to the diffrent detection for the frame and roi
// import React, { useState, useRef, useCallback } from "react";
// import { Box, Typography, IconButton, Tooltip, Paper } from "@mui/material";
// import {
//   PlayArrow,
...
//   const drawDetection = useCallback(
//     (data: any) => {
//       console.log("Drawing detection:", data);
//       if (!aiProcessingEnabled) return;

//       const frameId = data.frameId || data.frame_id;
...
//       // if (!lastFrameRef.current || frameId !== lastFrameRef.current.frameId) {
//       //   return;
//       // }
...
//         ctx.fillStyle = "red";
//         ctx.font = "14px Arial";
//         ctx.fillText(det.object, x1 + 4, y1 - 6);
//       });
//     },
//     [selectedCamera, aiProcessingEnabled, selectedUseCaseKafkaKey],
//   );
...
//   const drawLiveFrame = useCallback((frameMsg: any) => {
//     const frameId = frameMsg.frameId || frameMsg.frame_id;
...
//     const img = new Image();
//     img.src = `data:image/jpeg;base64,${frameMsg.frameData || frameMsg.frame}`;

//     img.onload = () => {
//       ctx.clearRect(0, 0, canvas.width, canvas.height);
//       ctx.drawImage(img, 0, 0, canvas.width, canvas.height);

//       lastFrameRef.current = { frameId, image: img };
//     };
//   }, []);
...
//   // });
//   // 🔴 Frames
//   useRealtimeSocket("http://192.168.0.5:4009", {
//     events: {
//       Live_Frame: drawLiveFrame,
//     },
//   });
