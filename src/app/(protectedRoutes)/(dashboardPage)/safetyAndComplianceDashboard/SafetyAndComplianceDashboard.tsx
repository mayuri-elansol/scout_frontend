...
//     (d): d is VehicleWalkwayResponse => d.title === "Forklift / Vehicle in Walkways",
//   );
        ...
        <Grid container sx={{ alignItems: "stretch", height: "100%" }}>
          ...
          >
            <DynamicBarChart
              ...
              xAxisKey="gate"
              series={[
                { dataKey: "blocked", label: "Blocked Hours", color: "#ffcdd2" },
                { dataKey: "clear", label: "Clear Hours", color: "#B0E0E6" },
              ]}
              yAxisLabel="Hours"
              stackId="exitStatus"
            />
